...
// Примечание: не знаю, зачем я пытаюсь всё усложнить...
// Я пыталась обезопасить программу от ошибок ввода пользователем,
// но это подразумевает использование кучи всего, что мы еще не изучали 
// так что я решила пока в этот "темный лес" не лезть.
